...
# If "GIT_AUTHOR_NAME" and "GIT_AUTHOR_EMAIL" variables are set, they will be
# used as the git comitter information.
...
def chart_url
    ...
    "https://github.com/#{repo}/releases/download/#{url_version}/#{file}"
end
...
Process.wait Process.spawn(%w(git add index.yaml))
